...
--
-- Author: wa18382
-- Date: Tuesday, November 26 17:50:05, 2019
---------------------------------------------------
...
begin
	...
	HsynchPulse_AUTOBUF : AUTO_OBUF
		port map( I => \20\, O => HsynchPulse );
	U2 : AND4_NI
		port map( A => \PLD1/bit0\, B => \PLD1/bit1\, C => \PLD1/bit2\, D => \PLD1/bit3\, Y => \17\ );
	U3 : INV_NI
		port map( Y => \5\, A => \PLD1/bit5\ );
	U4 : INV_NI
		port map( Y => \14\, A => \PLD1/bit6\ );
	U5 : INV_NI
		port map( Y => \15\, A => \PLD1/bit7\ );
	U21 : AND4_NI
		port map( A => \PLD1/bit4\, B => \5\, C => \15\, D => \14\, Y => \16\ );
	U22 : AND4_NI
		port map( A => \17\, B => \16\, C => \PLD1/bit8\, D => \PLD1/bit9\, Y => \18\ );
	U23 : INV_NI
		port map( Y => \PLD1/reset\, A => \18\ );
	U24 : AND4_NI
		port map( A => \PLD1/bit0\, B => \PLD1/bit1\, C => \PLD1/bit2\, D => \PLD1/bit3\, Y => \22\ );
	U26 : INV_NI
		port map( Y => \19\, A => \PLD1/bit5\ );
	U28 : AND2_NI
		port map( A => \22\, B => \21\, Y => \24\ );
	U27 : AND3_NI
		port map( A => \PLD1/bit4\, B => \19\, C => \PLD1/bit6\, Y => \21\ );
	U29 : FF_JK_NSCLR_CO_NI
		port map( Q => \20\, Qneg => open, PR => \23\, K => \18\, CLR => \23\, J => \24\, CLK => \PLD1/Pixelclock\ );
	U25 : DIGITAL_HIGH_NI
		port map( Y => \23\ );
	U6 : DIGITAL_HIGH_NI
		port map( Y => \2\ );
