...
HD_PWD='M:/CE 264/stage2/hsyctest/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hsynch_vsynch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hsynch_vsynch.tcl -notrace
