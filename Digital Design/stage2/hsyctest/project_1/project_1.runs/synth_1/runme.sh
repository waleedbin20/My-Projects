...
HD_PWD='M:/CE 264/stage2/hsyctest/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hsynch_vsynch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hsynch_vsynch.tcl
