...
HD_PWD='M:/CE 264/stage2/vsynchtest1/vsynchtest1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vsynchtest.vdi -applog -m64 -messageDb vivado.pb -mode batch -source vsynchtest.tcl -notrace
