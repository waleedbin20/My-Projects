...
HD_PWD='M:/CE 264/stage2/vsynchtest2/vsynchtest2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log backuphsynch.vdi -applog -m64 -messageDb vivado.pb -mode batch -source backuphsynch.tcl -notrace
