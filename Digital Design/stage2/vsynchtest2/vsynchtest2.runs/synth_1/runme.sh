...
HD_PWD='M:/CE 264/stage2/vsynchtest2/vsynchtest2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log backuphsynch.vds -m64 -mode batch -messageDb vivado.pb -notrace -source backuphsynch.tcl
